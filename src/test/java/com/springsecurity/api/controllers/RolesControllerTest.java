...
public class RolesControllerTest {
    ...
    @Test
    @IWithMockAdmin
    public void getRoles_shouldReturnOk() throws Exception {
        this.mockMvc.perform(get("/api/roles")).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @IWithMockModerator
    public void getRoles_shouldReturnOkModeratorUser() throws Exception {
        this.mockMvc.perform(get("/api/roles")).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @IWithMockUser
    public void getRoles_shouldReturnOkBasicUser() throws Exception {
        this.mockMvc.perform(get("/api/roles")).andDo(print()).andExpect(status().isOk());
    }
}
