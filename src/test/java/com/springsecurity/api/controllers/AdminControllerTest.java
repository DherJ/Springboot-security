...
public class AdminControllerTest {
    ...
    public void getUsers_shouldReturnOk() throws Exception {
        this.mockMvc.perform(get("/api/admin/users")).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @IWithMockModerator
    public void getUsers_shouldReturnOkModeratorUser() throws Exception {
        this.mockMvc.perform(get("/api/admin/users")).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @IWithMockUser
    public void getUsers_shouldReturnUnAuthorizedBasicUser() throws Exception {
        this.mockMvc.perform(get("/api/admin/users")).andDo(print()).andExpect(status().isForbidden());
    }
}
